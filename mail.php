	...
	$message = '
		<html>
			...
			<body>
				...
				<p>Внешняя темпиратура: '.$_POST['t-outside'].'</p>                     
				<p>Внутренняя темпиратура: '.$_POST['t-inside'].'</p>                     
				<p>Влажность: '.$_POST['humidity'].'</p>                     
				<p>Сопротивление стен: '.$_POST['wall-resistance'].'</p>                     
				<p>Сопротивление кровли: '.$_POST['roof-resistance'].'</p> 
				<h2>Внешний вид</h2>                    
